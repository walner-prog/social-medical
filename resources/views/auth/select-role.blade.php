    ...
    <div class="flex justify-center items-center min-h-screen">
        <div class="max-w-md w-full bg-white shadow-xl rounded-lg p-8 mt-10 transform transition-all duration-300 hover:scale-105">
            ...
            <p class="text-sm text-gray-600 mb-6 text-center">
                ¿Eres un doctor o un usuario comun? Por favor, selecciona tu rol para continuar.
            </p>
            ...
            <form action="{{ route('set-role', $user->id) }}" method="POST" class="space-y-6">
                ...
                <div class="flex flex-col space-y-4">
                    <label class="flex items-center space-x-3">
                        <input type="radio" name="role" value="doctor" class="accent-blue-500 rounded-full focus:ring-2 focus:ring-blue-500" required>
                        <span class="text-gray-700 font-medium">Doctor</span>
                    </label>
                    <label class="flex items-center space-x-3">
                        <input type="radio" name="role" value="patient" class="accent-blue-500 rounded-full focus:ring-2 focus:ring-blue-500">
