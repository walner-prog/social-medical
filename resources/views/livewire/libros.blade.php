        ...
        @foreach ($libros as $libro)
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 hover:shadow-2xl transition duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="mt-2 flex space-x-2">
                    ...
                    <button wire:click="deleteLibro({{ $libro['id'] }})" class="bg-red-900 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition duration-300 ease-in-out flex items-center space-x-2">
