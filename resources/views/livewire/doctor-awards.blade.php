                        ...
                        <tbody>
                            @foreach($awards as $award)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-900">
                                    <td class="border px-4 py-2 text-sm text-gray-700 dark:text-gray-300">{{ $award->award_name }}</td>
                                    <td class="border px-4 py-2 text-sm text-gray-700 dark:text-gray-300">{{ $award->awarding_institution }}</td>
                                    <td class="border px-4 py-2 text-sm text-gray-700 dark:text-gray-300">{{ $award->year }}</td>
                                    <td class="border px-4 py-2 text-sm text-gray-700 dark:text-gray-300">{{ $award->description }}</td>
                                    <td class="border px-4 py-2 text-sm text-gray-700 dark:text-gray-300">
                                        <div class="flex space-x-4">
                                        <button wire:click="editAward({{ $award->id }})" 
                                            class=" hover:text-blue-700 text-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded">
                                            <i class="fas fa-edit"></i> Editar
                                        </button>
                                        <button wire:click="deleteAward({{ $award->id }})" 
                                            class="text-red-500 hover:text-red-700 ml-4 focus:outline-none focus:ring-2 focus:ring-red-300 rounded">
